...
class MyAppAnimatedThemeSwitcher extends StatelessWidget {
  @override
    ...
    return ThemeProvider(
      ...
      builder: (_, myTheme) {
        return MaterialApp(
          title: 'Theme Demo',
          theme: myTheme,
          home: AnimatedThemeSwitcherScreen(),
        );
      },
    );
  }
...
class AnimatedThemeSwitcherScreen extends StatefulWidget {
  AnimatedThemeSwitcherScreen({Key? key}) : super(key: key);

  @override
  _AnimatedThemeSwitcherState createState() => _AnimatedThemeSwitcherState();
}

class _AnimatedThemeSwitcherState extends State<AnimatedThemeSwitcherScreen> {
  int _counter = 0;
